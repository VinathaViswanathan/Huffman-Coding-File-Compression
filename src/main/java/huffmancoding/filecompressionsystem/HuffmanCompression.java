package huffmancoding.filecompressionsystem;
...
import huffmancoding.filecompressionsystem.util.ByteNode;
import huffmancoding.filecompressionsystem.util.MinPriorityQueue;
...
public class HuffmanCompression {
    ...
    public static byte[] decomp(Map<Byte, String> huffmanCodes, byte[] huffmanBytes) {
        ...
        for (int i = 0; i < sb1.length(); ) {
            ...
            // Try to find a valid Huffman code substring
            while (i + count <= sb1.length()) {
            ...
            if (b == null) {
                // Cannot decode any more bits safely
                System.err.println("⚠️ Could not find a valid Huffman code at position " + i);
                break;
            }
    ...
    public static void main(String[] args) {
        // Example usage:
        // compress("/Users/vinatha/Downloads/test.txt", "/Users/vinatha/Downloads/test_compressed.txt");
        // To decompress:
        decompress("/Users/vinatha/Downloads/test_compressed.txt", "/Users/vinatha/Downloads/test_decompressed.txt");
    }
}
